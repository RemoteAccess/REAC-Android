...
public class MyHttpClient extends AsyncTask<Void,Void,Object> {
    ...
    public MyHttpClient(String url, ArrayList param, boolean isPost, MyHttpClientListener listener)
    {
        this.url = url;
        this.isPost = isPost;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            if (httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                exception = new Exception("ResponseCode:"+httpURLConnection.getResponseCode());//After 12 character
            }
